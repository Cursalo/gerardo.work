...
const ProjectWorldViewer = () => {
  ...
  const { setCurrentWorldId, refreshWorlds } = useWorld();
  ...
  useEffect(() => {
    ...
    loadWorld();
  }, [customLink, setCurrentWorldId, refreshWorlds, isTouchDevice]);
    ...
    return (
      <div style={styles.container}>
        <div style={styles.loadingContainer}>
          ...
          <div style={styles.loadingText}>Loading Project World...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div style={styles.container}>
        <div style={styles.errorContainer}>
          ...
          <h2 style={styles.errorTitle}>Error Loading Project World</h2>
  ...
  if (!world || !worldId) {
    return (
      <div style={styles.container}>
        <div style={styles.errorContainer}>
          <div style={styles.errorIcon}>⚠️</div>
          <h2 style={styles.errorTitle}>Project World Not Found</h2>
          <p style={styles.errorMessage}>
            The project world you're trying to view doesn't exist or hasn't been created yet.
          </p>
          <div>
...
export default ProjectWorldViewer; 